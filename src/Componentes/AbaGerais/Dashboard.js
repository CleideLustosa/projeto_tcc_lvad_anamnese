...
import { User, CalendarDays, Bell, TrendingUp } from 'lucide-react';
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div className="space-y-3">
          {pacientesEmConsulta.map((paciente) => (
            <div key={paciente.nome} className="flex items-center justify-between p-4 bg-gray-50 rounded-xl border border-gray-100">
              <div>
